...
Представляет собой универсальный компонент формы, в который подставляется любой шаблон необходимой формы, работает с отрисовкой формы.
...
3. Код, связывающий слой данных со слоем представления находится в файле index.ts и выполняет роль презентера (проект небольшой, дополнительная сущность не нужна).
