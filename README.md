...
- `catalog:changed` - событие генерируемое при подгрузке карточек товара в каталог
- `preview:changed` - выбор товара для отображения в модальном окне
- `modal:open` - открытие модального окна
- `modal:close` - закрытие модального окна
- `productCard:add` - добавление товара в корзину
- `productCard:remove` - удаление товара из корзины
- `shoppingCart:selected` - вызов отображения корзины в модальном окне
- `makeOrder:submit` - оформление заказа в модальном окне корзины
- orderInput:change -
- `userDataForm:input` - изменение данных в форме ввода адреса пользователя и выбора способа оплаты
- `userContactsForm:input` - изменение данных в форме ввода контактных данных пользователя
- `userDataFormErrors:changed'` - изменение состояния валидации формы ввода адреса пользователя и выбора способа оплаты
- `userContactsFormErrors:changed` - изменение состояния валидации формы ввода контактных данных пользователя
- `userDataForm:submit` -  сохранение введенных данных и переход к следующему шагу в форме ввода адреса пользователя и выбора способа оплаты
- `userContactsForm:submit` - сохранение введенных данных и переход к следующему шагу в форме контактных данных пользователя

- `success:submit` - подтверждение завершения заказа в модальном окне
